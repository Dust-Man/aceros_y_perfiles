...
<body>
    ...
    <div class="login">
        <form class="form" id="login" method="POST">
            ...
            <p id="error" style="display: none;" class="error-message">La Contraseña es incorrecta ,  intentalo de nuevo.</p>
...
<script src="../../scripts/enviar_login.js"></script>    
</body> 
